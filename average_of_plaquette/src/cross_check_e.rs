...
fn thermalize_with_e_field<D, Rng>(
    ...
    mp : &MultiProgress,
    rng: Rng,
) -> Result<(LatticeHamiltonianSimulationStateSyncDefault<LatticeStateDefault<D>, D>, Rng), ThermalizeError>
    where D: DimName + Eq,
...
#[allow(clippy::useless_format)]
fn measure(state_initial: LatticeHamiltonianSimulationStateSyncDefault<LatticeStateDefault<U3>, U3>, number_of_measurement: usize, mp: &MultiProgress) -> Result<(LatticeHamiltonianSimulationStateSyncDefault<LatticeStateDefault<U3>, U3>, Vec<Vec<f64>>), StateInitializationError> {
